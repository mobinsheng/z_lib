...
static z_amf_packet_t *amf_packet_analyze_number(
    unsigned char *raw_data, size_t raw_data_size, size_t *packet_size);
static z_amf_packet_t *amf_packet_analyze_boolean(
    unsigned char *raw_data, size_t raw_data_size, size_t *packet_size);
static z_amf_packet_t *amf_packet_analyze_string(
    unsigned char *raw_data, size_t raw_data_size, size_t *packet_size);
static z_amf_packet_t *amf_packet_analyze_object(
    unsigned char *raw_data, size_t raw_data_size, size_t *packet_size);
static z_amf_packet_t *amf_packet_analyze_null(void);
static z_amf_packet_t *amf_packet_analyze_undefined(void);
static z_amf_packet_t *amf_packet_analyze_ecma_array(
    unsigned char *raw_data, size_t raw_data_size, size_t *packet_size);

static size_t z_amf_packet_serialize_number(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size);
static size_t z_amf_packet_serialize_boolean(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size);
static size_t z_amf_packet_serialize_string(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size);
static size_t z_amf_packet_serialize_object(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size);
static size_t z_amf_packet_serialize_null(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size);
static size_t z_amf_packet_serialize_undefined(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size);
static size_t z_amf_packet_serialize_ecma_array(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size);


z_amf_packet_t *z_amf_packet_analyze_data(
    unsigned char *raw_data, size_t raw_data_size, size_t *packet_size)
{
    z_amf_packet_t *amf;
...
z_amf_packet_t *amf_packet_analyze_number(
    unsigned char *raw_data, size_t raw_data_size, size_t *packet_size)
{
    z_amf_packet_t *amf;
    ...
    amf = (z_amf_packet_t*)malloc(sizeof(z_amf_packet_number_t));
    if (amf == NULL) {
        return NULL;
    }
    amf->datatype = AMF_DATATYPE_NUMBER;
    amf->number.value = z_read_be64double(raw_data + 1);
#ifdef DEBUG
    printf("AMF number: %f\n", amf->number.value);
#endif
    if (packet_size) {
...
z_amf_packet_t *amf_packet_analyze_boolean(
    unsigned char *raw_data, size_t raw_data_size, size_t *packet_size)
{
    z_amf_packet_t *amf;
    ...
    amf = (z_amf_packet_t*)malloc(sizeof(z_amf_packet_boolean_t));
    if (amf == NULL) {
        return NULL;
    }
...
z_amf_packet_t *amf_packet_analyze_string(
    unsigned char *raw_data, size_t raw_data_size, size_t *packet_size)
{
    z_amf_packet_t *amf;
    ...
    string_data_length = z_read_be16int(raw_data + 1);
    ...
    amf = (z_amf_packet_t*)malloc(sizeof(z_amf_packet_string_t));
    if (amf == NULL) {
        return NULL;
    }
...
z_amf_packet_t *amf_packet_analyze_object(
    unsigned char *raw_data, size_t raw_data_size, size_t *packet_size)
{
    z_amf_packet_t *amf;
    ...
    z_amf_packet_object_property_t *property;
    z_amf_packet_object_property_t *previous_property;

    if (raw_data_size < 1) {
        return NULL;
    }

    amf = (z_amf_packet_t*)malloc(sizeof(z_amf_packet_object_t));
    if (amf == NULL) {
        return NULL;
    }
...
#endif
    while (1) {
        string_length = z_read_be16int(raw_data + raw_data_position);
        ...
        property = (z_amf_packet_object_property_t*)
            malloc(sizeof(z_amf_packet_object_property_t));
        if (property == NULL) {
        ...
        property->key = (char*)malloc(string_length + 1);
...
printf("out\n");
    ...
    printf("AMF object key: %d \"%s\"\n", string_length, property->key);
        ...
        property->value = z_amf_packet_analyze_data(
...
z_amf_packet_t *amf_packet_analyze_null(void)
{
    z_amf_packet_t *amf;

    amf = (z_amf_packet_t*)malloc(sizeof(z_amf_packet_null_t));
    if (amf == NULL) {
        return NULL;
    }
...
z_amf_packet_t *amf_packet_analyze_undefined(void)
{
    z_amf_packet_t *amf;

    amf = (z_amf_packet_t*)malloc(sizeof(z_amf_packet_undefined_t));
    if (amf == NULL) {
        return NULL;
    }
...
z_amf_packet_t *amf_packet_analyze_ecma_array(
    unsigned char *raw_data, size_t raw_data_size, size_t *packet_size)
{
    z_amf_packet_t *amf;
    int raw_data_position;
    ...
    amf = (z_amf_packet_t*)malloc(sizeof(z_amf_packet_ecma_array_t));
    if (amf == NULL) {
        return NULL;
    }
    amf->datatype = AMF_DATATYPE_ECMA_ARRAY;

    array_num = z_read_le32int(raw_data + 1);
...
void z_amf_packet_free(z_amf_packet_t *amf)
{
    z_amf_packet_object_property_t *property;
    ...
    case AMF_DATATYPE_OBJECT:
        ...
        while (property) {
            next = property->next;
            free(property->key);
            z_amf_packet_free(property->value);
            free(property);
            property = next;
        }
        break;
...
z_amf_packet_t *z_amf_packet_create_number(double number)
{
    z_amf_packet_t *amf;
...
z_amf_packet_t *z_amf_packet_create_boolean(int boolean)
{
    z_amf_packet_t *amf;
...
z_amf_packet_t *z_amf_packet_create_string(const char *string)
{
    z_amf_packet_t *amf;
...
z_amf_packet_t *z_amf_packet_create_object(void)
{
    z_amf_packet_t *amf;
...
z_rtmp_result_t z_amf_packet_add_property_to_object(
    z_amf_packet_t *amf, const char *key, z_amf_packet_t *value)
{
    z_amf_packet_object_property_t *property;
    z_amf_packet_object_property_t *last_property;
...
z_amf_packet_t *z_amf_packet_create_null(void)
{
    z_amf_packet_t *amf;
...
z_amf_packet_t *z_amf_packet_create_undefined(void)
{
    z_amf_packet_t *amf;
...
size_t z_amf_packet_get_size(z_amf_packet_t *amf)
{
    size_t size;
    z_amf_packet_object_property_t *property;
    ...
    case AMF_DATATYPE_OBJECT:
        ...
        while (property) {
            ...
            size += z_amf_packet_get_size(property->value);
...
size_t z_amf_packet_serialize(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size)
{
    switch (amf->datatype) {
    case AMF_DATATYPE_NUMBER:
        return z_amf_packet_serialize_number(
            amf, output_buffer, output_buffer_size);
    case AMF_DATATYPE_BOOLEAN:
        return z_amf_packet_serialize_boolean(
            amf, output_buffer, output_buffer_size);
    case AMF_DATATYPE_STRING:
        return z_amf_packet_serialize_string(
            amf, output_buffer, output_buffer_size);
    case AMF_DATATYPE_OBJECT:
        return z_amf_packet_serialize_object(
            amf, output_buffer, output_buffer_size);
    case AMF_DATATYPE_NULL:
        return z_amf_packet_serialize_null(
            amf, output_buffer, output_buffer_size);
    case AMF_DATATYPE_UNDEFINED:
        return z_amf_packet_serialize_undefined(
            amf, output_buffer, output_buffer_size);
    case AMF_DATATYPE_ECMA_ARRAY:
        return z_amf_packet_serialize_ecma_array(
            amf, output_buffer, output_buffer_size);
    case AMF_DATATYPE_OBJECT_END:
        break;
    default:
...
size_t z_amf_packet_serialize_number(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size)
{
    ...
    z_write_be64double(output_buffer + 1, amf->number.value);
#ifdef DEBUG
...
size_t z_amf_packet_serialize_boolean(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size)
{
...
size_t z_amf_packet_serialize_string(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size)
{
    size_t length;
    ...
    z_write_be16int(output_buffer + 1, (int)length);
...
size_t z_amf_packet_serialize_object(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size)
{
    z_amf_packet_object_property_t *property;
    ...
    while (property) {
        ...
        z_write_be16int(output_buffer + outputed_size, (int)key_length);
        memmove(
    ...
    printf("\n");
        ...
        serialized_value_size = z_amf_packet_serialize(
            property->value,
    ...
    z_write_be16int(output_buffer + outputed_size, 0);
    outputed_size += 2;
...
size_t z_amf_packet_serialize_null(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size)
{
    if (output_buffer_size < 1 ) {
...
size_t z_amf_packet_serialize_undefined(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size)
{
    if (output_buffer_size < 1 ) {
...
size_t z_amf_packet_serialize_ecma_array(
    z_amf_packet_t *amf,
    unsigned char *output_buffer, size_t output_buffer_size)
{
    z_amf_packet_object_property_t *property;
